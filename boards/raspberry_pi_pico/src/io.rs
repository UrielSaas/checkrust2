...
use kernel::utilities::cells::{OptionalCell, MapCell};
...
pub(crate) static WRITER: CoreLocal<MapCell<Writer>> = unsafe { CoreLocal::new_single_core(MapCell::new(Writer { uart: OptionalCell::empty() })) };
