...
impl<'a> ble_advertising::BleAdvertisementDriver<'a> for Radio<'a> {
    fn transmit_advertisement(&self, buf: &'static mut [u8], _len: usize, channel: RadioChannel) -> &'static mut [u8] {
    ...
    fn receive_advertisement(&self, channel: RadioChannel, buffer: &'static mut [u8]) -> &'static mut [u8] {
